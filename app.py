...
if section == "Products":
    ...
    if len(product_rev) > 0:
        ...
        st.markdown(
            f"""
        <div style="
            background: linear-gradient(135deg,#FCFCFA,#F6F8F9);
        ...
        <div style="display:flex;gap:22px;align-items:stretch;flex-wrap:wrap;">
            ...
            <div style="
                ...
                box-shadow:0 4px 10px rgba(46,125,50,.08);
            ">
                ...
                <div style="
                    ...
                    font-size:15px;
                    font-weight:600;">
                    {hero_share:.1f}% of Portfolio Revenue
                </div>
