        ...
        st.markdown(
            ...
            ">
                ...
                <div style="display: flex; flex-wrap: wrap; gap: 16px; align-items: stretch;">
                    ...
                    <!-- Hero Product Feature Item Card WITH ADDED BACKGROUND -->
                    <div style="
                        flex: 1.5; 
                        min-width: 260px; 
                        background-color: #FFFDFB; /* Soft background accent contrast */
                        padding: 18px 20px; 
                        border-radius: 10px; 
                        border: 1px solid #F5EBE6; /* Subtle warm border to frame the product name */
                        display: flex; 
